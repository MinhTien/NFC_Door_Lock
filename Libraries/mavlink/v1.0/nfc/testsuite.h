...
static void mavlink_test_general_msg(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_general_msg_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_general_msg_pack(system_id, component_id, &msg , packet1.address , packet1.value0 , packet1.value1 , packet1.value2 , packet1.value3 , packet1.value4 , packet1.value5 , packet1.value6 , packet1.value7 );
	mavlink_msg_general_msg_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_general_msg_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.address , packet1.value0 , packet1.value1 , packet1.value2 , packet1.value3 , packet1.value4 , packet1.value5 , packet1.value6 , packet1.value7 );
	mavlink_msg_general_msg_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_general_msg_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_general_msg_send(MAVLINK_COMM_1 , packet1.address , packet1.value0 , packet1.value1 , packet1.value2 , packet1.value3 , packet1.value4 , packet1.value5 , packet1.value6 , packet1.value7 );
	mavlink_msg_general_msg_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_mifare_classic_uid(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_mifare_classic_uid_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mifare_classic_uid_pack(system_id, component_id, &msg , packet1.address , packet1.byte0 , packet1.byte1 , packet1.byte2 , packet1.byte3 );
	mavlink_msg_mifare_classic_uid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mifare_classic_uid_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.address , packet1.byte0 , packet1.byte1 , packet1.byte2 , packet1.byte3 );
	mavlink_msg_mifare_classic_uid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_mifare_classic_uid_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mifare_classic_uid_send(MAVLINK_COMM_1 , packet1.address , packet1.byte0 , packet1.byte1 , packet1.byte2 , packet1.byte3 );
	mavlink_msg_mifare_classic_uid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_mifare_ultralight_uid(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_mifare_ultralight_uid_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mifare_ultralight_uid_pack(system_id, component_id, &msg , packet1.address , packet1.byte0 , packet1.byte1 , packet1.byte2 , packet1.byte3 , packet1.byte4 , packet1.byte5 , packet1.byte6 );
	mavlink_msg_mifare_ultralight_uid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mifare_ultralight_uid_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.address , packet1.byte0 , packet1.byte1 , packet1.byte2 , packet1.byte3 , packet1.byte4 , packet1.byte5 , packet1.byte6 );
	mavlink_msg_mifare_ultralight_uid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_mifare_ultralight_uid_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mifare_ultralight_uid_send(MAVLINK_COMM_1 , packet1.address , packet1.byte0 , packet1.byte1 , packet1.byte2 , packet1.byte3 , packet1.byte4 , packet1.byte5 , packet1.byte6 );
	mavlink_msg_mifare_ultralight_uid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_lock_control(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_lock_control_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_lock_control_pack(system_id, component_id, &msg , packet1.address , packet1.command );
	mavlink_msg_lock_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_lock_control_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.address , packet1.command );
	mavlink_msg_lock_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_lock_control_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_lock_control_send(MAVLINK_COMM_1 , packet1.address , packet1.command );
	mavlink_msg_lock_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_lock_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_lock_status_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_lock_status_pack(system_id, component_id, &msg , packet1.address , packet1.lockstatus );
	mavlink_msg_lock_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_lock_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.address , packet1.lockstatus );
	mavlink_msg_lock_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_lock_status_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_lock_status_send(MAVLINK_COMM_1 , packet1.address , packet1.lockstatus );
	mavlink_msg_lock_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_set_address(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_set_address_t packet_in = {
		17235,
	};
	mavlink_set_address_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.address = packet_in.address;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_address_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_set_address_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_address_pack(system_id, component_id, &msg , packet1.address );
	mavlink_msg_set_address_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_address_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.address );
	mavlink_msg_set_address_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_set_address_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_address_send(MAVLINK_COMM_1 , packet1.address );
	mavlink_msg_set_address_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_nfc(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_set_address(system_id, component_id, last_msg);
}
